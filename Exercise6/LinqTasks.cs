...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<object> Task11()
        {
                ...
                (dept,emp)=> new
            {
                ...
                .Where(emp=>emp.numOfEmployees>1);
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = Emps.WithMgr();
            return result;
        }
        ...
        {
            int result = arr.GroupBy(i => i)
                .Where(i=>i.Count()%2==1)
                .Select(i=>i.Key).Single();
            //result=
            return result;
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            ...
            }).Where(dept=> dept.eCount==5 || dept.eCount==0)
    ...
    {
        public static IEnumerable<Emp> WithMgr(this IEnumerable<Emp> emps)
        {
            return emps
                .Where(emp => emps
                    .Any(e => e.Mgr?.Empno == emp.Empno))
